...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/BDE/ShowcaseBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Train/CoreBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Train/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'BDE\\ShowcaseBundle\\Entity');
        $c->addDriver($b, 'Train\\CoreBundle\\Entity');
        $c->addDriver($b, 'Train\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('BDEShowcaseBundle' => 'BDE\\ShowcaseBundle\\Entity', 'TrainCoreBundle' => 'Train\\CoreBundle\\Entity', 'TrainUserBundle' => 'Train\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_67f0baec504b54f1963ccb4bcb9eac01da23173b0a554d02342c87eccd5b9142');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/index'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        ...
        $h->setOptions(array('login_path' => 'login', 'default_target_path' => 'train_core_adminpanel', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'main', $h, $i, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '567a053dde7f63.67503736', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('asa93@live.fr');
        $a->setPassword('purplePain_303');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(), 'ROLE_ADMIN' => array(0 => 'ROLE_AUTEUR', 1 => 'ROLE_MODERATEUR', 2 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'mdp_303', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BDEEventBundle' => 'BDE\\EventBundle\\BDEEventBundle',
                'BDEShowcaseBundle' => 'BDE\\ShowcaseBundle\\BDEShowcaseBundle',
                'TrainCoreBundle' => 'Train\\CoreBundle\\TrainCoreBundle',
                'TrainUserBundle' => 'Train\\UserBundle\\TrainUserBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdDebugProjectContainer',
            'database_driver' => 'mysqli',
            'database_host' => 'db554869185.db.1and1.com',
            'database_port' => 3306,
            'database_name' => 'db554869185',
            'database_user' => 'dbo554869185',
            'database_password' => 'dudul_303',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'asa93@live.fr',
            'mailer_password' => 'purplePain_303',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'asa93@live.fr',
            'swiftmailer.mailer.default.transport.smtp.password' => 'purplePain_303',
